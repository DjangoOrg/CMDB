    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[('0', '上线'), ('1', '下线'), ('2', '未知'), ('3', '故障'), ('4', '备用')], default=0, verbose_name='设备状态')),
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='admin', to=settings.AUTH_USER_MODEL, verbose_name='资产管理人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_day', models.DateField(blank=True, null=True, verbose_name='合同开始日期')),
                ('end_day', models.DateField(blank=True, null=True, verbose_name='合同结束日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset', verbose_name='CPU和资产表一对一关系')),
            ],
            options={
                'verbose_name': 'CPU组件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slot', models.CharField(blank=True, max_length=64, null=True, verbose_name='硬盘插槽')),
                ('model', models.CharField(blank=True, max_length=64, null=True, verbose_name='型号')),
                ('manufacturer', models.CharField(blank=True, max_length=128, null=True, verbose_name='制造厂家')),
                ('capacity', models.IntegerField(blank=True, null=True, verbose_name='硬盘容量(GB)')),
                ('interface_type', models.CharField(choices=[('SATA', 'SATA'), ('SAS', 'SAS'), ('SCSI', 'SCSI'), ('SSD', 'SSD'), ('unknow', 'unknow')], default='unknow', max_length=16, verbose_name='硬盘接口类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.SmallIntegerField(choices=[('0', '其他'), ('1', '硬件变更'), ('2', '新增配件'), ('3', '设备下线'), ('4', '设备上线'), ('5', '定期维护'), ('6', '业务上线\\更新')], default=0, verbose_name='事件类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[('0', '路由器'), ('1', '交换机'), ('2', '负载均衡器'), ('3', 'VPN设备')], default=0, verbose_name='网络设备类型')),
                ...
                ('port_num', models.SmallIntegerField(blank=True, null=True, verbose_name='端口数')),
                ('device_detail', models.TextField(blank=True, null=True, verbose_name='详细配置')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset', verbose_name='网络设备和资产表一对一关系')),
            ],
            options={
                'verbose_name': '网络设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('securitydevice', '安全设备'), ('IDC', '机房'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
                ('manufacturer', models.CharField(blank=True, max_length=128, null=True, verbose_name='生产厂家')),
                ('model', models.CharField(blank=True, max_length=64, null=True, verbose_name='资产型号')),
                ('ram_size', models.SmallIntegerField(blank=True, null=True, verbose_name='内存大小')),
                ('cpu_model', models.CharField(blank=True, max_length=64, null=True, verbose_name='cpu型号')),
                ...
                ('os_distribution', models.CharField(blank=True, max_length=64, null=True, verbose_name='系统发行版本')),
                ('os_type', models.CharField(blank=True, max_length=64, null=True, verbose_name='操作系统型号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip_addr', models.GenericIPAddressField(blank=True, null=True, verbose_name='网卡IP地址')),
                ('net_mask', models.GenericIPAddressField(blank=True, null=True, verbose_name='掩码')),
                ('bonding', models.GenericIPAddressField(blank=True, null=True, verbose_name='绑定地址')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset', verbose_name='网卡和资产表关联关系')),
            ],
            options={
                'verbose_name': '网卡',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(blank=True, max_length=64, null=True, verbose_name='内存型号')),
                ('manufacturer', models.CharField(blank=True, max_length=64, null=True, verbose_name='制造厂家')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset', verbose_name='安全设备和资产表一对一关系')),
            ],
            options={
                'verbose_name': '安全设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[('0', '服务器'), ('1', '刀片机'), ('2', '小型机')], default=0, verbose_name='服务器类型')),
                ('created_by', models.CharField(choices=[('auto', '自动添加'), ('manual', '手工录入')], default='auto', max_length=32, verbose_name='添加方式')),
                ('model', models.CharField(blank=True, max_length=64, null=True, verbose_name='服务器型号')),
                ('raid_type', models.CharField(blank=True, max_length=64, null=True, verbose_name='Raid卡型号')),
                ('os_type', models.CharField(blank=True, max_length=64, null=True, verbose_name='操作系统型号')),
                ('os_distribution', models.CharField(blank=True, max_length=64, null=True, verbose_name='发型版本')),
                ('os_release', models.CharField(blank=True, max_length=64, null=True, verbose_name='操作系统版本')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset', verbose_name='服务器和资产表一对一关系')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(help_text='例如：CentOS release 6.7 (Final)', max_length=128, verbose_name='软件版本')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset', verbose_name='软件资产和资产表一对一关系')),
            ],
            options={
                'verbose_name': '软件资产',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset', verbose_name='存储设备和资产表一对一关系')),
            ],
            options={
                'verbose_name': '存储设备',
        ...
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assets.BusinessUnit', verbose_name='所属业务线'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
        ...
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assets.IDC', verbose_name='所在机房'),
        ),
        migrations.AddField(
            model_name='asset',
            name='manufacturer',
        ...
        migrations.AddField(
            model_name='asset',
            name='tags',
            field=models.ManyToManyField(to='assets.Tag', verbose_name='标签'),
        ),
